...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, rgba(0, 163, 173, 0.15) 0%, rgba(0, 48, 61, 0.5) 100%)";
...
const ProfileCardComponent = ({
  ...
  behindGlowColor = "rgba(0, 163, 173, 0.4)",
  behindGlowSize = "50%",
  className = "",
  enableTilt = true,
  ...
  const getOffsets = (evt: PointerEvent, el: HTMLDivElement) => {
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(0, 163, 173, 0.4)",
